...
<template>
  <div class="mx-auto max-w-4xl space-y-6">
    <UCard class="shadow-sm">
      ...
      <div class="space-y-4">
        <div class="space-y-2 rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-600"><p class="font-semibold text-slate-800">Columnas recomendadas en el archivo:</p><p class="block rounded border border-slate-200 bg-white p-2 font-mono text-xs">ID Muestra, Coordenadas Muestreo, Dirección Muestreo, CaCO₃, CaO, MgO, SiO₂, Fe₂O₃, Al₂O₃, SO₃, Na₂O, K₂O</p><p>La aplicación validará todas las filas y guardará sus evaluaciones con la base seleccionada. Los campos ausentes permanecerán sin dato.</p></div>
